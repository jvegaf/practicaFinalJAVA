...
CREATE TABLE `MATRICULA` (
	...
	`CODIGO_PROFESOR` INT NOT NULL,
	`NOTA` INT,
 PRIMARY KEY (`CODIGO_MATRICULA`,`CODIGO_ALUMNO`,`CODIGO_ASIGNATURA`,`CODIGO_PROFESOR`)) ENGINE = INNODB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
ALTER TABLE `MATRICULA` ADD FOREIGN KEY (`CODIGO_ASIGNATURA`,`CODIGO_PROFESOR`) REFERENCES `ASIGNATURA` (`CODIGO_ASIGNATURA`,`CODIGO_PROFESOR`) ON DELETE  RESTRICT ON UPDATE  RESTRICT;
